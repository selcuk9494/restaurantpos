  ...
  getMeta() {
    return {
      ...
      endpoints: [
        ...
        'POST /v1/orders/items/update',
        'POST /v1/orders/items/remove',
        'GET /v1/orders/payment-summary',
        'GET /v1/orders/sales-summary',
        'GET /v1/orders/kitchen',
        'POST /v1/orders/items/status',
